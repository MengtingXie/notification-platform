...
func (s *TemplateServiceTestSuite) newChannelTemplateService(ctrl *gomock.Controller) (template.Service, *providermocks.MockProviderService, *auditmocks.auditmocks) {
