...
//
//	mockgen -source=./types.go -destination=./mocks/builder.mock.go -package=providermocks -typed SelectorBuilder
//
...
import (
	...
	provider "gitee.com/flycash/notification-platform/internal/service/provider"
