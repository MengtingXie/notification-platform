...
import (
	...
	templatemocks "gitee.com/flycash/notification-platform/internal/service/template/mocks"
	...
	}{
		{
			...
			setupMock: func(ctrl *gomock.Controller, provider *smsProvider) {
				...
				mockTemplateSvc.EXPECT().
					GetTemplate(gomock.Any(), testNotification.Template.ID, testNotification.Template.VersionID, "aliyun", domain.ChannelSMS).
