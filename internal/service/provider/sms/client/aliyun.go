...
// BatchQueryTemplateStatus TODO 需要重构
...
func (a *AliyunSMS) handleResponse(response *dysmsapi.QuerySmsTemplateListResponse, requestedIDMap map[string]bool, results map[string]QueryTemplateStatusResp) bool {
	var needStop bool
