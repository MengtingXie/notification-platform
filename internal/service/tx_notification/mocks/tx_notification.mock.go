...
// Package txnotificationmocks is a generated GoMock package.
package txnotificationmocks

import (
	context "context"
	reflect "reflect"

	domain "gitee.com/flycash/notification-platform/internal/service/tx_notification/internal/domain"
...
func (mr *MockTxNotificationServiceMockRecorder) GetNotification(ctx, bizID, key any) *MockTxNotificationServiceGetNotificationCall {
	mr.mock.ctrl.T.Helper()
	...
	return &MockTxNotificationServiceGetNotificationCall{Call: call}
}

// MockTxNotificationServiceGetNotificationCall wrap *gomock.Call
type MockTxNotificationServiceGetNotificationCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockTxNotificationServiceGetNotificationCall) Return(arg0 domain.TxNotification, arg1 error) *MockTxNotificationServiceGetNotificationCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockTxNotificationServiceGetNotificationCall) Do(f func(context.Context, int64, string) (domain.TxNotification, error)) *MockTxNotificationServiceGetNotificationCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockTxNotificationServiceGetNotificationCall) DoAndReturn(f func(context.Context, int64, string) (domain.TxNotification, error)) *MockTxNotificationServiceGetNotificationCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
